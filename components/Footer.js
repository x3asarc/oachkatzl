      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <span className="text-2xl font-bold text-white">Oachkatzl</span>
            <p className="text-sm leading-6 text-gray-300">
              Experience luxury living in our beautiful apartment in Austria. 
              Modern amenities, stunning views, and the perfect location for your next getaway.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li>
                    <a href="#amenities" className="text-sm leading-6 text-gray-300 hover:text-white">
                      Amenities
                    </a>
                  </li>
                  <li>
                    <a href="#gallery" className="text-sm leading-6 text-gray-300 hover:text-white">
                      Gallery
                    </a>
                  </li>
                  <li>
                    <a href="#booking" className="text-sm leading-6 text-gray-300 hover:text-white">
                      Book Now
                    </a>
                  </li>
                </ul>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-sm leading-5 text-gray-400">
              &copy; 2024 Appartement "Oachkatzl". All rights reserved.
            </p>
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-400">
                ...
                <span>+43 XXX XXX XXX</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-gray-400">
                <EnvelopeIcon className="h-4 w-4" />
                <span>info@oachkatzl-apartment.com</span>
              </div>
            </div>
          </div>
        </div>
